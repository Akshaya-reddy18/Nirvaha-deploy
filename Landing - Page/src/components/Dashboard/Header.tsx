...
const Header: React.FC<HeaderProps> = ({ activeTab, onTabChange, username, email, tabs }) => {
                ...
                <div className="p-6">
                  ...
                  {isEditing ? (
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <button
                        onClick={handleSave}
                        className="col-span-2 py-2 px-4 bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 transition-colors"
                      >
                        Save Changes
                      </button>
                    </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <button
                        ...
                        className="w-full py-2 px-4 bg-emerald-100 text-emerald-600 rounded-lg hover:bg-emerald-200 transition-colors mt-4"
                      >
                        Edit Profile
                      </button>
                    </div>
                  ...
                  <button
                    ...
                    className="w-full mt-4 py-2 px-4 text-red-600 hover:bg-red-50 rounded-lg transition-colors"
                  >
                    Logout
                  </button>
                </div>
